...
pipe.load_lora_weights(
    "/root/autodl-fs/output/ref_short_post_5_27/checkpoint-1500/pytorch_lora_weights.safetensors",
...
load_extra_components(
    args,
    transformer,
    "/root/autodl-fs/output/ref_short_post_5_27/checkpoint-1500/transformer_partial.pth",
)

pipe.fuse_lora()
pipe.unload_lora_weights()
pipe.transformer.save_pretrained(
    "/root/autodl-fs/output/ref_short_post_5_27/merged/transformer"
)
