...
transformer = HeliosTransformer3DModel.from_pretrained(
    "/root/autodl-fs/output/ablation_stage_1_init_smoke_test/merged",
...
pipe.load_lora_weights(
    "/root/autodl-fs/output/ablation_stage_2_init_smoke_test/checkpoint-100/pytorch_lora_weights.safetensors",
...
load_extra_components(
    args,
    transformer,
    "/root/autodl-fs/output/ablation_stage_2_init_smoke_test/checkpoint-100/transformer_partial.pth",
)

pipe.fuse_lora()
pipe.unload_lora_weights()
pipe.transformer.save_pretrained(
    "/root/autodl-fs/output/ablation_stage_2_init_smoke_test/merged/transformer"
)
