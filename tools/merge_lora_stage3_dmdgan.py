...
# Stage 3 DMD/GAN: 基础 transformer 来自 Stage 3 ODE 合并后的权重
transformer = HeliosTransformer3DModel.from_pretrained(
    "/root/autodl-fs/output/ablation_stage_3_ode_smoke_test/merged",
...
pipe.load_lora_weights(
    "/root/autodl-fs/output/ablation_stage_3_post_gan_smoke_test/checkpoint-100/model_ema/pytorch_lora_weights.safetensors",
...
args.training_config.is_use_gan = True  # DMD/GAN 阶段开启了 GAN
load_extra_components(
    args,
    transformer,
    "/root/autodl-fs/output/ablation_stage_3_post_gan_smoke_test/checkpoint-100/model_ema/transformer_partial.pth",
)

pipe.fuse_lora()
pipe.unload_lora_weights()
pipe.transformer.save_pretrained(
    "/root/autodl-fs/output/ablation_stage_3_post_gan_smoke_test/merged/transformer"
)
